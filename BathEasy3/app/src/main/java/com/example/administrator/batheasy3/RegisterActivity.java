...
import com.example.administrator.batheasy3.InternalWithServer.ServerReturnRegisterMsg;
import com.example.administrator.batheasy3.InternalWithServer.UserRegister;
    ...
    private void yanzheng(){
        ...
        if(telephone.equals("")||password.equals("")||password2.equals("")){
            ...
            if(!password.equals(password2)){
                ...
                HttpUtils hu = new HttpUtils("Register",new Gson().toJson(ur).toString());
                hu.start();
                ...
                printLog("获取预约成功");
                ServerReturnRegisterMsg srrm = new Gson().fromJson(clientInfo, ServerReturnRegisterMsg.class);
                if (srrm.getRegisterState().equals("注册成功")) {
                    Log.w("RegisterActivity", "注册成功！");
                    Toast.makeText(RegisterActivity.this, "注册成功!", LENGTH_SHORT).show();
                    finish();
